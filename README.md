...
![Réception de messages sur TTN](../master/IMG/TTN.png)
...
![Communication avec le port série de l'ordinateur](../master/IMG/Interrup.PNG)
...
Afin de d'afficher les données mesurés par le capteur de gaz et envoyées sur le cloud (TTN), nous avons utilisé l'interface graphique Node-RED, très pratique. 
...
![Code sous Node Red - bloc](../master/IMG/node-red4.png)
![Code sous Node Red - Fonction payload](../master/IMG/node-red5.png)
![Graph 1](../master/IMG/node-red1.png)
![Graph 2](../master/IMG/node-red2.png)
![Graph 3](../master/IMG/node-red3.png)
